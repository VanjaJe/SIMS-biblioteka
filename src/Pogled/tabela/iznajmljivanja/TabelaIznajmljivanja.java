...
public class TabelaIznajmljivanja extends JTable{

	
	private static final long serialVersionUID = -5716755961802477234L;

	public TabelaIznajmljivanja(TabelaModelIznajmljivanja tabelaModelIznajmljivanja) {
		this.setRowSelectionAllowed(true);
		this.setColumnSelectionAllowed(true);
		this.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		this.setModel( tabelaModelIznajmljivanja);
